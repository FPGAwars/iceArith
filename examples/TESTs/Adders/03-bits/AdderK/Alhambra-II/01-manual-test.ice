  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "e6a01046-24fe-4ee3-84eb-6ef11a906480",
          "type": "basic.input",
          "data": {
            "name": "btn",
            "range": "[2:0]",
        ...
        {
          "id": "6965539a-f4e1-4bdb-8cc6-357d5c6f43e5",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[2:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## AdderK-3bits: Manual testing with pushbutons and LEDs",
            "readonly": true
          },
          "position": {
            "x": -104,
        ...
        {
          "id": "da0a662c-9c9b-483a-b912-f533226cf877",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "da0a662c-9c9b-483a-b912-f533226cf877",
        ...
        },
        {
          ...
          "target": {
            "block": "6965539a-f4e1-4bdb-8cc6-357d5c6f43e5",
            "port": "in"
          },
          "size": 3
        },
        {
          "source": {
            "block": "e6a01046-24fe-4ee3-84eb-6ef11a906480",
            "port": "out"
          },
          "target": {
            "block": "da0a662c-9c9b-483a-b912-f533226cf877",
