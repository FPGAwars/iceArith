  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "fc9cdab6-c59b-44eb-9881-722809d9c85a",
          "type": "basic.input",
          "data": {
            "name": "btn",
            "range": "[3:0]",
        ...
        {
          "id": "819f18a7-7696-40f3-bd35-2162565172ab",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[3:0]",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## AdderK-4bits: Manual testing with pushbutons and LEDs",
            "readonly": true
          },
          "position": {
            "x": -104,
        ...
        {
          "id": "41ed64ba-c72e-4396-a09d-9ddae42d1c69",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "41ed64ba-c72e-4396-a09d-9ddae42d1c69",
        ...
        {
          "source": {
            "block": "fc9cdab6-c59b-44eb-9881-722809d9c85a",
            "port": "out"
          },
          "target": {
            "block": "41ed64ba-c72e-4396-a09d-9ddae42d1c69",
        ...
        },
        {
          ...
          "target": {
            "block": "819f18a7-7696-40f3-bd35-2162565172ab",
            "port": "in"
          },
          "size": 4
        }
