{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "82ac1a83-2c34-4480-bd9d-c9ad73c5f437",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[4:0]",
        ...
        {
          "id": "4d57ca84-1cb8-4482-8c99-2ca175cd1f6c",
          "type": "basic.input",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "e8ee04a4-8c56-40e8-8562-1e4aec1b2174",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "'h1F",
        ...
        {
          "id": "2b564f6e-e21a-4800-a7f6-c6d96fce142b",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "1",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "## AdderK-5bits: Manual testing with pushbutons and LEDs",
            "readonly": true
          },
          "position": {
            "x": -152,
        ...
        {
          "id": "15574d3b-9329-4ef6-8371-eb5aa9e116db",
          "type": "504af1eabc67205ce26b97967245738d5b831375",
          "position": {
            "x": 192,
            "y": 232
          },
        ...
        {
          "id": "784df946-68aa-4aee-8a24-8612bf7ba138",
        ...
        {
          "id": "20a3d0e6-709f-4d52-8db5-3f06fc4830e6",
        ...
        {
          "id": "dfd504e3-e102-4389-802a-b776acc0327c",
          "type": "2049fcfe8f5cb64552efe93640772776267b8a33",
          "position": {
            "x": 24,
            "y": 216
          },
      ...
      "wires": [
        {
          "source": {
            "block": "2b564f6e-e21a-4800-a7f6-c6d96fce142b",
            "port": "constant-out"
          },
          "target": {
            "block": "15574d3b-9329-4ef6-8371-eb5aa9e116db",
        ...
        },
        {
          ...
          "target": {
            "block": "82ac1a83-2c34-4480-bd9d-c9ad73c5f437",
            "port": "in"
          },
          "size": 5
        },
        {
          "source": {
            "block": "e8ee04a4-8c56-40e8-8562-1e4aec1b2174",
            "port": "constant-out"
          },
          "target": {
            "block": "784df946-68aa-4aee-8a24-8612bf7ba138",
        ...
        },
        {
          ...
          "target": {
            "block": "dfd504e3-e102-4389-802a-b776acc0327c",
            "port": "0dde784f-cfa7-4418-81f7-b13cad37971f"
          },
          "size": 5
        },
        {
          "source": {
            "block": "20a3d0e6-709f-4d52-8db5-3f06fc4830e6",
            "port": "98e81f4b-d4eb-46c1-8750-25f681a5f2cf"
          },
          "target": {
            "block": "dfd504e3-e102-4389-802a-b776acc0327c",
            "port": "79e95ce7-9457-43ff-9f62-d17fceac9762"
          },
          "vertices": [
            {
              "x": -88,
        ...
        },
        {
          "source": {
            "block": "dfd504e3-e102-4389-802a-b776acc0327c",
            "port": "1745aabe-b9ce-4dbc-aeb9-15bccb4116fd"
          },
          "target": {
            "block": "15574d3b-9329-4ef6-8371-eb5aa9e116db",
        ...
        {
          "source": {
            "block": "4d57ca84-1cb8-4482-8c99-2ca175cd1f6c",
            "port": "out"
          },
          "target": {
            "block": "dfd504e3-e102-4389-802a-b776acc0327c",
  ...
  "dependencies": {
    "504af1eabc67205ce26b97967245738d5b831375": {
      "package": {
        "name": "AdderK-5bits",
        "version": "0.1",
    ...
    "2049fcfe8f5cb64552efe93640772776267b8a33": {
      "package": {
        "name": "5-bits-Mux-2-1",
        "version": "0.1",
        "description": "2-to-1 Multplexer (5-bit channels)",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "0dde784f-cfa7-4418-81f7-b13cad37971f",
              "type": "basic.input",
              "data": {
                "name": "1",
                "range": "[4:0]",
            ...
            {
              "id": "1745aabe-b9ce-4dbc-aeb9-15bccb4116fd",
              "type": "basic.output",
              "data": {
                "name": "",
                "range": "[4:0]",
            ...
            {
              "id": "79e95ce7-9457-43ff-9f62-d17fceac9762",
              "type": "basic.input",
              "data": {
                "name": "0",
                "range": "[4:0]",
            ...
            {
              "id": "d25e99bd-5fd5-4130-807d-6356da3a6f3b",
              "type": "91f34c6a4c46f3eb4479d6090ae1d29c05788ace",
              "position": {
                "x": 376,
                "y": 264
            ...
            {
              "id": "8aaafc7a-5863-4e40-b68f-71a79e4551e1",
              "type": "91f34c6a4c46f3eb4479d6090ae1d29c05788ace",
              "position": {
                "x": 392,
                "y": 592
            ...
            {
              "id": "8088a1fe-80fc-4aa6-b07c-6822d119bb20",
              "type": "cdce799110ee37492653f85b55b2a21702b3f96d",
              "position": {
                "x": 1152,
                "y": 432
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "d25e99bd-5fd5-4130-807d-6356da3a6f3b",
                "port": "46d0d18b-5e8f-449d-9c4d-b396e055fe23",
                "size": 4
              },
              "target": {
            ...
            {
              "source": {
                "block": "8aaafc7a-5863-4e40-b68f-71a79e4551e1",
                "port": "46d0d18b-5e8f-449d-9c4d-b396e055fe23",
                "size": 4
              },
              "target": {
            ...
            {
              "source": {
                "block": "79e95ce7-9457-43ff-9f62-d17fceac9762",
                "port": "out"
              },
              "target": {
                "block": "8aaafc7a-5863-4e40-b68f-71a79e4551e1",
            ...
            {
              "source": {
                "block": "0dde784f-cfa7-4418-81f7-b13cad37971f",
                "port": "out"
              },
              "target": {
                "block": "d25e99bd-5fd5-4130-807d-6356da3a6f3b",
            ...
            },
            {
              ...
              "target": {
                "block": "8088a1fe-80fc-4aa6-b07c-6822d119bb20",
                "port": "7a06b833-8809-4020-878d-00d0dd758dce"
              },
              "size": 4
            },
            ...
            },
            {
              ...
              "target": {
                "block": "1745aabe-b9ce-4dbc-aeb9-15bccb4116fd",
                "port": "in"
              },
              "size": 5
            }
