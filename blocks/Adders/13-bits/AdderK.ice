{
  ...
  "package": {
    "name": "AdderK-13bits",
    "version": "0.5",
    "description": "AdderK-13bit: Adder of 13-bit operand and 13-bit constant",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "d3f26928-df48-47f7-963b-d6c4a3e75fa0",
          "type": "basic.input",
          "data": {
            "name": "",
            "virtual": true,
        ...
        {
          "id": "ed425bee-0e29-44fb-9443-b1df080d4002",
          "type": "basic.output",
          "data": {
            "name": "s",
            "virtual": true,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "d3f26928-df48-47f7-963b-d6c4a3e75fa0",
            "port": "out"
          },
          "target": {
            "block": "2ad3d9b5-c810-4c17-b74b-9fc432126626",
        ...
        },
        {
          ...
          "target": {
            "block": "ed425bee-0e29-44fb-9443-b1df080d4002",
            "port": "in"
          },
          "size": 13
        }
